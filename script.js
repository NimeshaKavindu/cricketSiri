...
const API_KEY = "AIzaSyAA8emBpp0yawLRZcFUWE2B-_DYpOvhAw8";
...
messageInput.addEventListener("input", ()=>{
    ...
    document,querySelector(".chat-form").style.borderRqadius = messageInput.scrollHeight > initialInputHeight ? "15px"  : "32px";
});
